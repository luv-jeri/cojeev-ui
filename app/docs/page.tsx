...
import { Display, SectionTitle, Body, BodySecondary } from "@/registry/cojeev/ui/typography";
export default function Documentation() {
  return <DocsPage full breadcrumb={{ enabled: false }} footer={{ enabled: false }} tableOfContent={{ enabled: false }} tableOfContentPopover={{ enabled: false }}>
    <article className="docs-article">
      ...
      <nav className="docs-related" aria-label="Start exploring"><Link className="docs-related-link" href="/docs/button/">Explore components <span aria-hidden="true">↗</span></Link><Link className="docs-related-link" href="/docs/adjuster/">Explore motion <span aria-hidden="true">↗</span></Link><a className="docs-related-link" href="https://github.com/luv-jeri/cojeev-ui">Source on GitHub <span aria-hidden="true">↗</span></a></nav>
    </article>
  </DocsPage>;
}
