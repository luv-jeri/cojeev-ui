      ...
      <div className="docs-page-grid">
        <article className="docs-article">
          ...
          <section className="docs-section" aria-labelledby="install-heading">
            ...
            {entry.meta.source.reviewOnly ? <BodySecondary>This addition is available in the local preview, with source and generated registry files in this checkout. Copy its example above; the public install command will become available after publication.</BodySecondary> : <>
            <InstallCommand
