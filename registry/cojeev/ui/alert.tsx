...
export type AlertProps=React.ComponentProps<"div"> & VariantProps<typeof AlertVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
...
export type AlertBodyProps=React.ComponentProps<"div"> & VariantProps<typeof AlertBodyVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
...
export type AlertTitleProps=React.ComponentProps<"div"> & VariantProps<typeof AlertTitleVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
...
export type AlertDescriptionProps=React.ComponentProps<"div"> & VariantProps<typeof AlertDescriptionVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
...
export type AlertKickerProps=React.ComponentProps<"div"> & VariantProps<typeof AlertKickerVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
...
export type AlertIconProps=React.ComponentProps<"span"> & VariantProps<typeof AlertIconVariants> & { as?:React.ElementType<React.ComponentProps<"span">> }
...
export type AlertActionsProps=React.ComponentProps<"div"> & VariantProps<typeof AlertActionsVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
...
export type AlertCloseProps=React.ComponentProps<"button"> & VariantProps<typeof AlertCloseVariants> & { as?:React.ElementType<React.ComponentProps<"button">> }
