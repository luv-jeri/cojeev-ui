...
import { Message, MessageContent, MessageDescription } from "@/registry/cojeev/ui/message";
import { MessageScroller, MessageScrollerJump, type MessageScrollerProps } from "@/registry/cojeev/ui/message-scroller";
import { Attachment, AttachmentType, AttachmentName, AttachmentMeta, AttachmentActions, AttachmentAction } from "@/registry/cojeev/ui/attachment";
...
import { Bubble, BubbleContent } from "@/registry/cojeev/ui/bubble";
import { Input } from "@/registry/cojeev/ui/input";
import { MotionPresence, MotionSurface } from "@/registry/cojeev/ui/presence";
import { InputGroup, InputGroupAddon, InputGroupTextarea, InputGroupButton } from "@/registry/cojeev/ui/input-group";
...
export function AgentChatHeader({ title = "Cojeev", description, status = "idle", statusLabel, actions, className, children, ...props }: AgentChatHeaderProps) {
...
export function AgentChatMessage({ author = "Cojeev", from = "agent", avatar, meta, actions, className, children, ...props }: AgentChatMessageProps) {
...
export function AgentChatComposer({ value, onValueChange, onSend, status = "idle", onStop, attachments = [], onAttach, onRemoveAttachment, accept, disabled = false, placeholder = "Ask, explore, or make something…", label = "Message Cojeev", hint, error, onRetry, maxLength = 12000, className, children, ...props }: AgentChatComposerProps) {
