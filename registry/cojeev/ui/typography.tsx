...
export type TypographyProps=React.ComponentProps<"div"> & VariantProps<typeof TypographyVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
...
export type HeroProps=React.ComponentProps<"h1"> & VariantProps<typeof HeroVariants> & { as?:React.ElementType<React.ComponentProps<"h1">> }
...
export type DisplayProps=React.ComponentProps<"h1"> & VariantProps<typeof DisplayVariants> & { as?:React.ElementType<React.ComponentProps<"h1">> }
...
export type SectionTitleProps=React.ComponentProps<"h2"> & VariantProps<typeof SectionTitleVariants> & { as?:React.ElementType<React.ComponentProps<"h2">> }
...
export type TitleProps=React.ComponentProps<"h3"> & VariantProps<typeof TitleVariants> & { as?:React.ElementType<React.ComponentProps<"h3">> }
...
export type LeadProps=React.ComponentProps<"p"> & VariantProps<typeof LeadVariants> & { as?:React.ElementType<React.ComponentProps<"p">> }
...
export type BodyProps=React.ComponentProps<"p"> & VariantProps<typeof BodyVariants> & { as?:React.ElementType<React.ComponentProps<"p">> }
...
export type BodySecondaryProps=React.ComponentProps<"p"> & VariantProps<typeof BodySecondaryVariants> & { as?:React.ElementType<React.ComponentProps<"p">> }
...
export type ControlTextProps=React.ComponentProps<"span"> & VariantProps<typeof ControlTextVariants> & { as?:React.ElementType<React.ComponentProps<"span">> }
...
export type MetaProps=React.ComponentProps<"span"> & VariantProps<typeof MetaVariants> & { as?:React.ElementType<React.ComponentProps<"span">> }
...
export type CapsProps=React.ComponentProps<"span"> & VariantProps<typeof CapsVariants> & { as?:React.ElementType<React.ComponentProps<"span">> }
...
export type ValueProps=React.ComponentProps<"span"> & VariantProps<typeof ValueVariants> & { as?:React.ElementType<React.ComponentProps<"span">> }
...
export type IdentifierProps=React.ComponentProps<"code"> & VariantProps<typeof IdentifierVariants> & { as?:React.ElementType<React.ComponentProps<"code">> }
