...
export function Label({as:Tag="label",className,variant,size,...props}:LabelProps){return React.createElement(Tag,{"data-slot":"label","data-part":"root",className:cn(LabelVariants({variant,size}),className),...props})}
...
export type StatsProps=React.ComponentProps<"div"> & VariantProps<typeof StatsVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
...
export type StatProps=React.ComponentProps<"div"> & VariantProps<typeof StatVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
