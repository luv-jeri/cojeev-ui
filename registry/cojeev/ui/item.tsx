...
export type ItemProps=React.ComponentProps<"button"> & VariantProps<typeof ItemVariants> & { as?:React.ElementType<React.ComponentProps<"button">> }
...
export type ItemGroupProps=React.ComponentProps<"div"> & VariantProps<typeof ItemGroupVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
export function ItemGroup({as:Tag="div",ref:externalRef,className,variant,size,...props}:ItemGroupProps){const ref=useFlowGroup<HTMLDivElement>(externalRef);const ownedMorphRef = useMorph<HTMLDivElement>("cards", ref);
  return <Tag ref={ownedMorphRef} data-slot="item" data-part="root" className={cn(ItemGroupVariants({variant,size}),className)} {...props}/>}
...
export type ItemContentProps=React.ComponentProps<"div"> & VariantProps<typeof ItemContentVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
...
export type ItemTitleProps=React.ComponentProps<"div"> & VariantProps<typeof ItemTitleVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
...
export type ItemDescriptionProps=React.ComponentProps<"div"> & VariantProps<typeof ItemDescriptionVariants> & { as?:React.ElementType<React.ComponentProps<"div">> }
...
export type ItemTrailingProps=React.ComponentProps<"span"> & VariantProps<typeof ItemTrailingVariants> & { as?:React.ElementType<React.ComponentProps<"span">> }
export function ItemTrailing({ref: externalMorphRef, as:Tag="span",className,variant,size,...props}:ItemTrailingProps){const ownedMorphRef = useMorph<HTMLSpanElement>("pills", externalMorphRef);
  return <Tag ref={ownedMorphRef} data-slot="item-trailing" data-part="trailing" className={cn(ItemTrailingVariants({variant,size}),className)} {...props}/>}
