...
import { appearanceTokens, defaultAppearance, normalizeAppearance, palettes, type AppearanceSettings } from "@/registry/sahajiv/lib/appearance-tokens";
...
import { Popover, PopoverTrigger, PopoverContent } from "@/registry/sahajiv/ui/popover";
...
export { palettes, defaultAppearance } from "@/registry/sahajiv/lib/appearance-tokens";
export type { AppearanceSettings, PaletteName } from "@/registry/sahajiv/lib/appearance-tokens";
const storageKey = "sahajiv-appearance";
const settingsEvent = "sahajiv:appearance-settings";
...
export function AppearanceProvider({ children }: { children: React.ReactNode }) {
  React.useEffect(() => {
    ...
    const apply = () => {
      ...
      window.dispatchEvent(new Event("sahajiv:appearancechange"));
    };
