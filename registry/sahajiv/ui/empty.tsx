...
export function Empty({as:Tag="div",className,variant,size,...props}:EmptyProps){return <Tag data-slot="empty" data-part="root" className={cn(EmptyVariants({variant,size}),className)} {...props}/>}
...
export function EmptyState({as:Tag="div",className,variant,size,...props}:EmptyStateProps){return <Tag data-slot="empty-state" data-part="state" className={cn(EmptyStateVariants({variant,size}),className)} {...props}/>}
