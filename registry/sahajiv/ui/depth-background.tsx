...
export function depthBackgroundPoints(variant: DepthBackgroundVariant, density = 1, seed: number | string = "sahajiv") {
  let hash = 2166136261;
...
export function DepthBackground({ variant = "pollen", density = 1, intensity = 1, seed = "sahajiv", className, ref, ...props }: DepthBackgroundProps) {
