...
export function SkeletonGroup({as:Tag="div",className,variant,size,...props}:SkeletonGroupProps){return <Tag data-slot="skeleton" data-part="root" className={cn(SkeletonGroupVariants({variant,size}),className)} {...props}/>}
