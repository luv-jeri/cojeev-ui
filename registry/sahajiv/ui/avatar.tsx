...
export function Avatar({className,variant,size,...props}:AvatarProps){return <AvatarPrimitive.Root data-slot="avatar" data-part="root" className={cn(AvatarVariants({variant,size}),className)} {...props}/>}
...
export function AvatarHex({className,variant,size,...props}:AvatarHexProps){return <span data-slot="avatar-hex" data-part="hex" className={cn(AvatarHexVariants({variant,size}),className)} {...props}/>}
