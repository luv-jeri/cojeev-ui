...
test('deployment configuration cannot redirect resources to the other environment',()=>{
  assert.throws(()=>validateDeploymentConfig('beta',{name:'cojeev-ui-reporting',account_id:'25369d7051a3d996a1bca81f462a1fbc'},'api'),/target/);
});
