...
export type CatalogEntry = {name:string;title:string;description:string;meta:{api:{name:string;props:{name:string;type:string;required:boolean;description:string}[]}[];source:{variants:string[];sizes:string[];states:string[]};fidelity:string}};
