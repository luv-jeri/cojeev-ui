# CHANGELOG.md — Cojeev Design System handoffs
...
### Docs
- `readme.md` describes only the shipping system; the Grove/Cojeev kit notes moved to `_archive/legacy-grove/ARCHIVE.md`.
