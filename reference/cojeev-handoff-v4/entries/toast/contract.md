...
- **id** `toast` · **tier** base · **evidence** Ext · **status** derived
- **root** `[data-toast]`
...
- **isolation canvas** 480x240 · **files** `isolation/toast/`
...
| state | expression |
|---|---|
| `open` | toast present in .v-toaster · durable stays until dismissed |
| `rest` | default |
...
| selector | part |
|---|---|
| `.v-toaster` | `data-part="viewport"` |
| `.v-toast` | `data-part="root"` |
| `.v-toast button` | `data-part="action"` |
