# Hex Participant Group — contract

- **id** `hex-group` · **tier** composite · **evidence** I04 I18 · **status** source
- **root** `.v-hexgroup`
- **api** .v-hexgroup > .v-hex[style=--c]×n + .v-more · 24 px flat-top hexagons, 9 px initials
- **isolation canvas** 960x600 · **files** `isolation/hex-group/`
...
v-hex, v-hexgroup, v-meta, v-more
