...
1. **Unlock the Mac and make Chrome available.** The last account-browser attempt returned `User unavailable`. Existing sign-ins do not themselves supply the missing deployment credentials.
