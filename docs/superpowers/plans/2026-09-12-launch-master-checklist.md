...
- [ ] **W02 · C — Recover the persistent workspace and reconcile accepted checkpoints.** Restore the pushed release after restart, verify the local preview, preserve the dirty original checkout and record merged polish/check evidence. [Recovery record](../../production/2026-09-13-restart-recovery.md). This documentation checkpoint closes on its checked PR merge; it does not close the combined release or live launch.
