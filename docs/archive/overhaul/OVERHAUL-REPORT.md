...
- **Library-built documentation:** Fumadocs remains the framework; visible navigation, previews, controls, inputs, scrolling and theme controls use Cojeev components. [DESIGN.md](../../design/DESIGN.md) records the implemented palette, typography, spacing and motion ownership.
