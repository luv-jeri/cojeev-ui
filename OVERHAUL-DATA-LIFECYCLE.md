...
```sh
node scripts/check-overhaul-data-lifecycle.mjs --url=http://127.0.0.1:4320/cojeev-ui
node scripts/check-overhaul-data-lifecycle.mjs --url=http://127.0.0.1:4320/cojeev-ui --only=followup --output=output/playwright/data-table-lifecycle-followup
